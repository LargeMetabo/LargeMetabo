...
#' Title AnnotaTandem
#'
#' @param Parent_mass The value of parent ion mass for metabolite annotation of Tandem mass spectrum.
#' @param TandemData The value of MS/MS peak list (m/z & Intensity) for metabolite annotation of Tandem mass spectrum.
#' @param massTandem The tolerance of parent ion mass for metabolite annotation of Tandem mass spectrum.
#' @param toleUnitTandem The unit of parent ion mass for metabolite annotation of Tandem mass spectrum. The unit could be 1 for Da, or 2 for ppm.
#' @param massmzTandem The tolerance of MS/MS peak mass for metabolite annotation of Tandem mass spectrum.
#' @param toleUnitmzTandem The unit of MS/MS peak mass for metabolite annotation of Tandem mass spectrum. The unit could be 1 for Da, or 2 for ppm.
#' @param ModeTandem The ionization mode for metabolite annotation of Tandem mass spectrum. The mode could be Positive or Negative.
#' @param ionEnergy The CID energy for metabolite annotation of Tandem mass spectrum. The mode could be low(10V) Medium(25V) High(40V) or All.
#'
#' @return The parameters of metabolite annotation of Tandem mass spectrum.
#' @export
#'
#' @examples Parent_mass <- AnnotaData$Parent_mass
#' TandemData <- AnnotaData$TandemData
#' AnnotaTandem(Parent_mass, TandemData)

AnnotaTandem <- function(Parent_mass = 181.04, TandemData, massTandem = 0.1, toleUnitTandem = 1, massmzTandem = 0.5, toleUnitmzTandem = 1, ModeTandem = "Positive", ionEnergy = "low(10V)"){
  ...
  paramTandem$Parent_mass <- Parent_mass
...
AnnotationTandem <- function(AnnotaParamTandem){
  ...
  mzT <- AnnotaParamTandem$Parent_mass
...
##########
#' Title annotaDataTandem
#'
#' @param AnnotaParamTandem The parameters of metabolite annotation of Tandem mass spectrum.
#'
#' @return The table of results for metabolite annotation of Tandem mass spectrum.
#' @export
#'
#' @examples Parent_mass <- AnnotaData$Parent_mass
#' TandemData <- AnnotaData$TandemData
#' AnnotaParamTandem <- AnnotaTandem(Parent_mass, TandemData)
#' annotaDataTandem(AnnotaParamTandem)

annotaDataTandem <- function(AnnotaParamTandem){
...
#' Title AnnotaTandem_plot
#'
#' @param AnnotaParamTandem The parameters of metabolite annotation of Tandem mass spectrum.
#' @param TandemData The value of MS/MS peak list (m/z & Intensity) for metabolite annotation of Tandem mass spectrum.
#'
#' @return The plot of results for metabolite annotation of Tandem mass spectrum.
#' @export
#'
#' @examples Parent_mass <- AnnotaData$Parent_mass
#' TandemData <- AnnotaData$TandemData
#' AnnotaParamTandem <- AnnotaTandem(Parent_mass, TandemData)
#' annotaDataTandem(AnnotaParamTandem)
#' AnnotaTandem_plot(AnnotaParamTandem, TandemData)

AnnotaTandem_plot <- function(AnnotaParamTandem, TandemData){
